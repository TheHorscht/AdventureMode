...
async(function() 
  ...
  camera_tracking_shot(x, y, door_x + 25, door_y + 25, 0.01)
  -- Clear pixel scene
  LoadPixelScene("mods/AdventureMode/files/door_remover.png", "", door_x, door_y, "", true)
  -- Open door
...
-- ></SpriteParticleEmitterComponent>
  ...
  camera_tracking_shot(door_x + 25, door_y + 25, x, y, 0.01)
